...
public class JwtService {
    ...
    public String generateToken(Employe employe) {
        ...
        claims.put("role", employe.getRole());
        claims.put("roleCode", employe.getRoleCode());
        claims.put("nom", employe.getNom());
        claims.put("prenom", employe.getPrenom());
        claims.put("email", employe.getEmail());
